...
if [ $run_type = 't' ]
then
    # cargo run --release angular $DATASET bruteforce
    cargo run --release angular $DATASET kmeans [10] [2000 100] [[16]]
    cargo run --release angular $DATASET pq [10] [10 2000 250000 256 100] [[16 3072] [24 3072] [32 4096] [64 8192]]
...
then
    ...
    cargo run --release angular $DATASET pq [10] [50 2000 250000 256 100] [[16 512] [24 1024] [64 2048] [72 3072] [88 4096] [128 8192] [128 12288] [192 16384] [256 32768] [384 73728]]
