...
then
    ...
    cargo run --release $METRIC $DATASET pq [10] [5 64 1000 255 200] [1 2 3 4 5 10 20 40 64]
    cargo run --release $METRIC $DATASET pq [10] [5 128 1000 255 200] [1 2 3 4 5 10 20 40 100 128]
    cargo run --release $METRIC $DATASET pq [10] [5 256 1000 255 200] [1 2 3 4 5 10 20 40 100 200 256]
    cargo run --release $METRIC $DATASET pq [10] [5 512 1000 255 200] [1 2 3 4 5 10 20 40 100 200 400 512]
