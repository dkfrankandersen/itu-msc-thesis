...
impl AlgorithmFactory {
    pub fn get(verbose_print: bool, algorithm: &str, args: Vec<String>) -> Algorithm {
        match algorithm.as_ref() {
            ...
            "pq" => Algorithm::ProductQuantization(ProductQuantization::new(verbose_print, args[0].parse::<usize>().unwrap(), args[1].parse::<usize>().unwrap(), args[2].parse::<usize>().unwrap(), args[3].parse::<usize>().unwrap())),
