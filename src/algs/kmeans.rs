...
impl KMeans {
    ...
    pub fn run<T: RngCore>(&self, rng: T, k_centroids: usize, max_iterations: usize,
        ...
        for iterations in 0..max_iterations  {
            ...
            // Assign
            let mut point_allocations: Vec::<usize> = (0..dataset.nrows()).collect();
            point_allocations.par_iter_mut().for_each(|index| {
                ...
                *index = best_centroid_idx;
            });

            for datapoint_idx in 0..point_allocations.len() {
                centroids[point_allocations[datapoint_idx]].indexes.push(datapoint_idx);
            }
